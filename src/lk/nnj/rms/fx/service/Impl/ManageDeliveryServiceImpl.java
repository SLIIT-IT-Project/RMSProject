...
public class ManageDeliveryServiceImpl implements IManageDeliveryService {
    @Override
    public boolean add(Delivery manageDelivery) throws Exception {
    ...
    @Override
    public boolean Edit (Delivery manageDelivery) throws Exception {
            Connection connection = DBConnection.getConnection();
    ...
    @Override
    public Delivery find(int id) throws Exception {
        Connection connection = DBConnection.getConnection();
    ...
    public List<Delivery> findAll() throws Exception {
        ...
        while(rst.next())
        {
            ...
            Delivery delivery = new Delivery(Track_id,Del_date_time,Status,Note,Delivered_by,Order_id);
