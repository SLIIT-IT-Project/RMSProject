...
public class MangeDelivery {
    ...
    public MangeDelivery(int track_id, Timestamp del_date_time, String status, String note, String delivered_by, int order_id) {
